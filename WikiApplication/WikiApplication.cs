...
namespace WikiApplication
{
    public partial class WikiApplication : Form
    {
        ...
        // but clicks add button.
        {
            ...
            {
                toolStripStatusLabel1.Text = "Error: Text boxes are empty.";
                textBoxName.Focus();
            }
        }
        #endregion
        ...
        private void Delete()
        {
            ...
            {
                ClearStatusMessage();
                toolStripStatusLabel1.Text = "Error: Not a valid action. ";
            }
        }
        #endregion
            ...
            try
            {
                ...
                if (currentRecord >= 0)
                {
                    ...
                    else
                    {
                        ...
                        toolStripStatusLabel1.Text = "Data item not changed. ";
                    }
                }
            }
            catch (ArgumentOutOfRangeException)
        ...
        private void ButtonSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                while (!flag && !((finalIndex - startIndex) <= 1))
                {
                    ...
                    string userInput = textBoxSearch.Text = textBoxSearch.Text.Substring(0, 1).ToUpper() + textBoxSearch.Text.Substring(1);
            ...
            {
                MessageBox.Show("Error! Use search textbox to find an item.");
                textBoxSearch.Focus();
            }
        ...
        private void Sort()
        {
            for (int x = 0; x < rowSize - 1; x++)
            {
                for (int i = 0; i < rowSize - 1; i++)
                {
                    ...
                    {
                        if (string.CompareOrdinal(dataStructures[i, 0], dataStructures[i + 1, 0]) > 0)
                        {
                            Swap(i);
                        }
                    }
        ...
        private void TextBoxSearch_MouseDoubleClick(object sender, MouseEventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(textBoxSearch.Text))
            {
                ClearSearchBox();
                ClearTextBoxes();
                toolStripStatusLabel1.Text = "Search textbox and text boxes cleared.";
            }
            else
            {
                toolStripStatusLabel1.Text = "Search box is empty!";
            }
        }
        #endregion
        ...
        {
            dataStructures[0, 0] = "January";
            dataStructures[1, 0] = "February";
            dataStructures[2, 0] = "March";
            dataStructures[3, 0] = "April";

            dataStructures[0, 1] = "May";
            dataStructures[1, 1] = "June";
            dataStructures[2, 1] = "July";
            dataStructures[3, 1] = "August";

            dataStructures[0, 2] = "September";
            dataStructures[1, 2] = "October";
            dataStructures[2, 2] = "November";
            dataStructures[3, 2] = "December";

            dataStructures[0, 3] = "Monday";
            dataStructures[1, 3] = "Tuesday";
            dataStructures[2, 3] = "Wednesday";
            dataStructures[3, 3] = "Thursday";
            ptr += 4;
            DisplayArray();
        }
        #endregion
        ...
        // Clear status message everytime the form is clicked.
